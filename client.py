...
def askPlayerName():
    ...
    button = Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=7, command=saveName, height=1, bg="#80deea", bd=3)
    button.place(x = screen_width/5, y=screen_height/4)
